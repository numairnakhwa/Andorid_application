...
public class TabFragments extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DatabaseHelper_Appoint DA=new DatabaseHelper_Appoint(this);
        DA.deleteappoint(year+""+month+""+day);
    ...
    public void onBackPressed() {
        super.onBackPressed();
        startActivity(new Intent(TabFragments.this,Activity1.class));
    }

    @Override
    public boolean onCreateOptionsMenu(Menu menu) {
        // Inflate the menu; this adds items to the action bar if it is present.
        getMenuInflater().inflate(R.menu.menu_tab_fragments, menu);
        return true;
    }
